...
export function ContactoDeliveyMotoFija() {
  return (
    <section className="w-full py-12 md:py-20 lg:py-24 bg-primary text-primary-foreground"> {/* Primary background for high contrast */}
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-6 text-center">
          ...
          <p className="max-w-[600px] text-primary-foreground/80 md:text-lg">
            Contáctanos para más información sobre nuestros servicios de Moto Fija y cómo podemos ayudarte.
          </p>
          <Button
            asChild
            size="lg"
          ...
          >
            <Link
              href="https://wa.me/+542236602699?text=Hola!%20Encontré%20su%20contacto%20en%20el%20sitio%20web%20y%20me%20gustaría%20más%20información%20sobre%20el%20servicio%20de%20Moto%20Fija."
              target="_blank"
